...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "BARIUM " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"BARIUMtools.com", "18.217.78.40"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"BARIUMtools.com", "testnet-seed.BARIUMtools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. BARIUM is probably already running."), addrBind.ToString().c_str());
        else
